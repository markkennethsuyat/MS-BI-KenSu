CREATE TABLE [Fact].[Purchase] (
    ...
    CONSTRAINT [PK_Fact_Purchase] PRIMARY KEY CLUSTERED ([Purchase Key] ASC),
    CONSTRAINT [FK_Fact_Date_Key_Dimension_Date] FOREIGN KEY ([Date Key]) REFERENCES [Dimension].[Date] ([Date]),
