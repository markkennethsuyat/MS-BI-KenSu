CREATE TABLE [Fact].[Order] (
    ...
    CONSTRAINT [PK_Fact_Order] PRIMARY KEY CLUSTERED ([Order Key] ASC),
    ...
    CONSTRAINT [FK_Fact_Order_Date_Key_Dimension_Date] FOREIGN KEY ([Order Date Key]) REFERENCES [Dimension].[Date] ([Date]),
    CONSTRAINT [FK_Fact_Order_Picked_Key_Dimension_Date] FOREIGN KEY ([Picked Date Key]) REFERENCES [Dimension].[Date] ([Date]),
